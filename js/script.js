...
// ===== ANIMACION DELIVERY SCROLL =====

window.addEventListener("scroll", () => {

  const bike = document.getElementById("data-delivery-boy");
  ...
  if (sectionRect.top < windowHeight && sectionRect.bottom > 0) {
    ...
    let progress = (windowHeight - sectionRect.top) / windowHeight;

    // Limitar rango 0 - 1
    progress = Math.max(0, Math.min(progress, 1));

    // Movimiento máximo 120px
